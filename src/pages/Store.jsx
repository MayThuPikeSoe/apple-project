...
const Store = () => {
  ...
  // };
  return (
    <div className="mt-32  h-auto mb-32 ">
      <h1 className="text-5xl font-medium container">
        Store.{" "}
      ...
      <div className="store_card h-auto my-20 container">
        <Slider {...settings}>
          {storeCards.map((card) => (
            <article
              key={card.id}
              className="flex justify-center items-center 2xl:w-[140px] w-[100px] 2xl:h-[120px] 2xl:px-2 px-0"
            >
      ...
      <div className="h-auto latest">
        ...
        >
          {storeLatest.map((card, index) => (
            <SwiperSlide
              key={index}
              className=" lg:max-w-[400px] min-w-[400px] h-[500px]  rounded-[30px]"
            >
              <img
                src={card.image}
      ...
      <div className="h-auto latest">
        ...
        >
          {specialists.map((card, index) => (
            <SwiperSlide
              key={index}
              className=" lg:max-w-[400px] min-w-[400px] h-[500px] relative rounded-[30px] border"
            >
              <img
                src={card.image}
                className="object-cover w-full h-full rounded-[30px]"
              ...
              <div className="absolute top-5 left-5 z-50">
                <p className="text-gray-400 text-sm">APPLE SPECIALIST</p>
                <h2 className="2xl:text-2xl sm:text-xl text-lg font-bold">
                  Shop one on one with a <br />
                  Specialist.Online or in a store
                </h2>
              </div>
            </SwiperSlide>
          ))}
      ...
      <div className="h-auto latest">
        ...
        <Swiper
          ...
          onSlideChange={() => console.log("slide change")}
        >
          {/* {differentsCard.map((card, index) => (
            <SwiperSlide
              key={index}
              className=" lg:max-w-[400px] min-w-[400px] h-[300px] rounded-[30px] bg-gray-200 border"
            >
              <div className="p-10">
                <svg
                  width="49"
          ...
          <SwiperSlide className=" lg:max-w-[320px] min-w-[320px] h-[250px] rounded-[30px] bg-white border p-8">
            <svg
              width="49"
              height="56"
              viewBox="0 0 49 56"
            ...
            <p className="text-2xl font-medium">
              ...
              <span>from an Apple Store</span> <span>free delivery</span>{" "}
              <span>or </span>
